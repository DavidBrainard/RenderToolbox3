...
% generated by the same executive script, as determined by the names of
% data folders.  For each matched pair of outputs, compares multi-spectral
% renderings and makes difference images.
%
% @details
% Data sets must use a particular folder structure.  For each data file,
% the expected path is:
% @code
%   outputRoot/executive-script-name/renderer-name/data-name.mat
% @endcode
% outputRoot is either @a outputRootA or @a outputRootB.
% executive-script-name must be the name of an executive script such as
% "MakeDragon".  renderer-name must be the name of a renderer, either
% "PBRT" or "Mitsuba".  data-name must be the name of a multi-spectral data
% file, such as "Dragon-001".
%
% @details
